...
function AdminLayout() {
  ...
  return (
    <div className="bg-background py-24 sm:bg-white">
          ...
          <ul className="sm:no-scrollbar w-full sm:flex sm:gap-[24px] sm:overflow-y-scroll">
            {pages.map((page) => (
              <li key={page.id} className="w-full text-base text-cardText">
                <NoStyleLink
                  link={page.link}
                  className="block h-full w-full whitespace-nowrap p-[1.667vw] sm:bg-background sm:px-[24px] sm:py-[20px] sm:text-mb-base"
                  activeClassName="bg-white text-main border-l-[4px] border-lightGreen font-normal sm:border-l-0 sm:border-b-[4px]"
                >
                  {page.label}
                </NoStyleLink>
              </li>
